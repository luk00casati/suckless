...
static const char col_cyan[]        = "#C28D4B";   // "#005577"; default blue
...
static const char *dmenucmd[] = { "dmenu_run_history", "-c", "-l", "20", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
